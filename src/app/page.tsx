...
export default function Home() {
  ...
  return (
    <main className="flex h-screen flex-col overflow-hidden bg-[#1b1a1f] text-zinc-100">
      ...
      <div
        className="pointer-events-none fixed bottom-4 left-4 z-[70] flex max-w-[min(100vw-2rem,280px)] flex-col items-stretch gap-2 sm:bottom-5 sm:left-5"
        aria-label="Raccourcis"
      >
        {shareToast ? (
          <p className="pointer-events-none rounded-lg border border-zinc-600/90 bg-zinc-900/95 px-3 py-2 text-xs font-medium text-zinc-100 shadow-[0_8px_30px_rgba(0,0,0,0.45)]">
            {shareToast}
          </p>
        ) : null}
        <div className="pointer-events-auto flex flex-col gap-2">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#5865F2]/80 bg-[#5865F2]/90 px-4 py-2.5 text-sm font-bold text-white shadow-lg transition hover:bg-[#4752C4] hover:shadow-xl"
          >
          ...
          <button
            ...
            disabled={hands.length === 0 || selectedHand.id === "__empty__"}
            title="Copier ou partager le résumé texte de la main affichée"
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-zinc-500/80 bg-zinc-800/95 px-4 py-2.5 text-sm font-bold text-zinc-100 shadow-lg transition hover:border-zinc-400 hover:bg-zinc-700/95 disabled:cursor-not-allowed disabled:opacity-45"
          >
            <svg
